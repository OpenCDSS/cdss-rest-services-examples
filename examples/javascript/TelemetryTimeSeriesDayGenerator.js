    ...
    (function (TelemetryTimeSeriesDay, undefined) {
        /**
         * @param {function} callback          Function whose first parameter contains the TelemetryTimeSeriesDay data, or null if an error occurs
         ...
         * @param {string}   offset            string input. Add an asterisk on the front and/or end to be used as a wildcard. Time offset to grab the data for
        ...
        **/
        TelemetryTimeSeriesDay.getData = function(callback, pager, apiKey, abbrev, endDate, includeThirdParty, modified, offset, parameter, startDate) {
            var query;
            var handleAsGeoJson;
            ...
            query = addToQuery(query, processString("offset", offset));
            ...
            var baseUrl = "https://dwr.state.co.us/Rest/GET/api/v2/telemetrystations/telemetrytimeseriesday/";
                ...
                xhr.onload = function () {
                    if (xhr.status === 200) {
                        ...
                        var returnObject = {
                             ...
                             * @param {function} nextCallback Function whose first parameter contains the TelemetryTimeSeriesDay data, or null if an error occurs
                             **/
                             ...
                             * @param {function} prevCallback Function whose first parameter contains the TelemetryTimeSeriesDay data, or null if an error occurs
                             **/
        ...
        TelemetryTimeSeriesDay.createPager = function(pageSize, pageIndex) {
            return {
                pageSize: pageSize,
                pageIndex: pageIndex
            };
    ...
    }(window.TelemetryTimeSeriesDay = window.TelemetryTimeSeriesDay || {}));
